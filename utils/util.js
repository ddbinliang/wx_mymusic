...
//推荐新歌单 recommended list
function getRecommendList(id,callback){
  wx.request({
    url: "http://route.showapi.com/213-4?showapi_appid=38241&showapi_sign=8d037e7fe3e9463bb7f30955df87e7ea&topid="+id+"&",
    method: 'GET',
    ...
    success: function (res) {
      if (res.statusCode == 200) {
        ...
        for (let i = 0; i < toplist.length; i++) {
          toplist[i].listenCount = formatUnit(toplist[i].listenCount);
        }
        callback(res.data);
      }
    }
...
//获取电台
function getMusicRadio(callback) {
  wx.request({
